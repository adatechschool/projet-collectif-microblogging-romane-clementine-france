...
<x-app-layout>
    ...
    <div class="flex flex-wrap justify-around my-4"
        ...
        @foreach ($post as $objet)
            <div class="max-w-sm rounded overflow-hidden shadow-lg mx-4 mb-4 md:w-1/4" style='margin-left:1rem; width:22%'>
                ...
                <div class="px-6 pt-4 pb-2">
                    <span
                        class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">{{ $objet->user_id }}</span>
                    <span
